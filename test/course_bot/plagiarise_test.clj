...
(deftest essay-plagiarize-test
  (let [forest (plagiarism/get-test-forest "./test-databases/example-forest")
        db (tt/test-database)]
    ...
    (testing "should detect plagiarism"
      ...
      (codax/with-read-transaction [db tx]
        (let [res (plagiarism/is-essay-plagiarised forest plagiarised-essay "bad-student" "essay1" tx)]
