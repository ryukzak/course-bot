...
(deftest schedule-agenda-and-drop-talks-test
  (let [conf (misc/get-config "conf-example/csa-2023.edn")
    ...
    (tt/with-mocked-morse *chat
      ...
      (talk 0 "/lab1drop 1")
      (tt/match-history *chat
                        (tt/text 0 "Name: Alice; Group: gr1; Telegram ID: 1; Group for first laboratory work: lgr1")
      ...
      (tt/match-history *chat
                        (tt/text 0 "Name: Bob; Group: gr1; Telegram ID: 2; Group for first laboratory work: lgr1")
